...
public class SootAnalyzer extends Analyzer {
    ...
    public SootAnalyzer(String apk, String androidJAR, String name, String pack, String sdkVersion, String targetSdkVersion, boolean mainPackageOnly) {
        this.apk = apk;
        this.androidJAR = androidJAR;
        this.pack = pack;
        this.paprikaApp = PaprikaApp.createPaprikaApp(name, pack, sdkVersion, targetSdkVersion);
